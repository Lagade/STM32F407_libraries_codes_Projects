...
typedef struct
{
	...
	uint8_t        Sr;          // To stor repeated start value
}I2C_Handle_t;

/*
 * I2C_SCLSpeed
 */
#define I2C_SCL_SPEED_SM       100000   //STD mode (SM) 100khz
...
/*
 * I2C status register flag definitions
 */
...
void I2C_CloseReceiceData(I2C_Handle_t *pI2CHandle);
